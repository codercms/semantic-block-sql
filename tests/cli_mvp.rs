...
#[test]
fn generated_go_file_ignore_can_be_disabled() {
    let project = TempDir::new().expect("temp project");
    write(
        project.path(),
        "semblock.toml",
    ...
    write(
        project.path(),
        "generated.go",
        r#"// Code generated by example. DO NOT EDIT.
package sample
...
"#,
    ...
    let output = run(project.path(), &["fmt", "generated.go"], None);

    assert_eq!(output.status.code(), Some(0), "{output:?}");
    assert!(
        fs::read_to_string(project.path().join("generated.go"))
            .expect("read generated Go")
